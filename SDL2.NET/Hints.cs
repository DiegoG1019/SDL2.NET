...
public static class Hints
{
    ...
    /// </remarks>
    public static AccelerometerAsJoystick AccelerometerAsJoystick { get; } = new();
...
#warning come back for SDL_RWFromFile
    ...
    /// </remarks>
    public static AndroidSeparateMouseAndTouch AndroidSeparateMouseAndTouch { get; } = new();
    ...
    /// </remarks>
    public static AppleTVControllerUIEvents AppleTVControllerUIEvents { get; } = new();
    ...
    /// When UI events are generated by controller input, the app will be backgrounded when the Apple TV remote's menu button is pressed, and when the pause or B buttons on gamepads are pressed.
    /// </remarks>
    public static AppleTVRemoteAllowRotation AppleTVRemoteAllowRotation { get; } = new();
    ...
    /// </remarks>
    public static BMPSaveLegacyFormat BMPSaveLegacyFormat { get; } = new();
    ...
    /// </remarks>
    public static EmscriptenAsyncify EmscriptenAsyncify { get; } = new();
